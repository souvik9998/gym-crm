...
const MESSAGE_CATEGORIES: Array<{ key: string; label: string; description: string; group: string; vars: string[] }> = [
  ...
  { key: "holiday_notification",group: "Manual / Admin",   label: "Holiday Notification",description: "Sent to members when a gym holiday / closure is announced from the Calendar.", vars: ["branch_name", "date", "closed_status", "holiday_name"] },
];
