...
// Create income entry for gym membership/renewal/daily pass/event
export const createMembershipIncomeEntry = async (
  amount: number,
  category: "gym_membership" | "gym_renewal" | "daily_pass" | "pt_subscription" | "joining_fee" | "event_registration",
  description: string,
  memberId?: string,
  dailyPassUserId?: string,
  paymentId?: string,
...
// Convenience: event registration income entry
export const createEventRegistrationIncomeEntry = async (params: {
  amount: number;
  eventTitle: string;
  ...
  await createLedgerEntry({
    ...
    description: `Event registration: ${params.eventTitle} — ${params.registrantName}`,
    amount: params.amount,
