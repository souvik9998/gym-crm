...
const StaffManagement = () => {
  ...
  return (
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full max-w-md grid-cols-3 mb-4 lg:mb-6">
          <TabsTrigger value="trainers" className="flex items-center gap-1 lg:gap-2 text-[11px] lg:text-sm px-1.5 lg:px-3">
            <AcademicCapIcon className="w-3.5 h-3.5 lg:w-4 lg:h-4" />
            <span>Trainers</span>
          </TabsTrigger>
          <TabsTrigger value="staff" className="flex items-center gap-1 lg:gap-2 text-[11px] lg:text-sm px-1.5 lg:px-3">
            <UserGroupIcon className="w-3.5 h-3.5 lg:w-4 lg:h-4" />
            <span>Other Staff</span>
          </TabsTrigger>
          <TabsTrigger value="overview" className="flex items-center gap-1 lg:gap-2 text-[11px] lg:text-sm px-1.5 lg:px-3">
