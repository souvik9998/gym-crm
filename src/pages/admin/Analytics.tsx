...
const AdminAnalytics = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-3 sm:space-y-5">
      {/* Sticky filter bar */}
      <div data-tour="analytics-period" className="sticky top-0 z-10 -mx-3 sm:mx-0 px-3 sm:px-0 py-2 sm:py-0 bg-background/80 backdrop-blur-md sm:bg-transparent sm:backdrop-blur-0">
      ...
      {/* Main revenue chart */}
      <div data-tour="analytics-revenue">
        <RevenueChartSection />
      </div>

      {/* Secondary analytics grid */}
      <div data-tour="analytics-growth">
        <MemberGrowthSection />
      </div>
      ...
      <PageTour tourId="analytics" steps={ANALYTICS_STEPS} autoStart={false} />
    </div>
  );
};
